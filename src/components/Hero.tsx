  ...
  return <section className="relative min-h-[70vh] md:min-h-[600px] flex items-center overflow-visible md:overflow-hidden pt-20 md:pt-0">
      ...
      <div className="relative container mx-auto px-4 text-white animate-fade-in" dir="rtl">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mb-4">
            <p className="text-lg text-white/90 font-bold leading-snug md:text-4xl md:leading-tight md:tracking-wide"><bdi dir="rtl" className="block sm:hidden">Your Journey. Their Wisdom.</bdi><bdi dir="rtl" className="block sm:hidden">One Connection.</bdi><bdi dir="rtl" className="hidden sm:inline">Your Journey. Their Wisdom. One Connection.</bdi></p>
          </div>
