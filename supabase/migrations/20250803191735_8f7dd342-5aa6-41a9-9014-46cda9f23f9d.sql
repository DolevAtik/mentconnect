-- Phase 1: Role-Based Access Control System (Fixed)
...
-- Create function to prevent user_type manipulation
...
-- Add trigger to prevent user_type changes
CREATE TRIGGER prevent_user_type_manipulation
  BEFORE UPDATE ON public.profiles
  FOR EACH ROW
  EXECUTE FUNCTION public.check_user_type_update();
